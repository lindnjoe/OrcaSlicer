...
void PhysicalPrinterDialog::build_printhost_settings(ConfigOptionsGroup* m_optgroup)
{
    ...
    option = m_optgroup->get_option("spoolman_host");
    option.opt.width = Field::def_width_wider();
...
{
    std::vector<std::string> keys = {"print_host", "spoolman_host", "print_host_webui", "printhost_apikey", "printhost_cafile", "printhost_user", "printhost_password", "printhost_port"};
    for (auto &key : keys) {
